...
Room.create(name: "Rebel Base Hangar", city: "Hoth", price: "4242.89", lat: 37.780437, lng: -122.513693, description: "A very large open space designed to hold rebel starships, but perfect for your large parties or events! Just watch out for AT-ATs coming to destroy the base.", bedrooms: 1, beds: 20, bathrooms: 1, homeType: "hangar", img_url: "http://res.cloudinary.com/candyentropy/image/upload/v1493100169/hoth_h3af07_s0rupw.jpg", accommodates: 40);

Room.create(name: "Townhome", city: "Tatooine", price: "4242.89", lat: 37.780437, lng: -122.513693, description: "A 3 story townhome that's waiting for your weekend getaway. Come experience the scorching dry heat of the Tatooine desert to get away from your cold icy planets!", bedrooms: 2, beds: 2, bathrooms: 1, homeType: "townhome", img_url: "http://res.cloudinary.com/candyentropy/image/upload/v1493100173/tatooine_townhome_llcjbq_xouyzq.jpg", accommodates: 4);

Room.create(name: "Rebel Temple", city: "Yavin IV", price: "4242.89", lat: 37.780437, lng: -122.513693, description: "Are you looking to throw a wild tropical party? This is the place! Huge cavernous spaces that can hold squadrons of starships or a DJ and dancefloor, multiple guest rooms for your guests, and beautiful tropical scenery.", bedrooms: 30, beds: 60, bathrooms: 10, homeType: "hangar", img_url: "http://res.cloudinary.com/candyentropy/image/upload/v1493100182/Yavin_4_Temple_ds5iy9_hkpcmp.png", accommodates: 120);
